...
Shader "LTCGI_Amplify"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Emission = ( ( diffuse15_g1 * 0.05 ) + ( specular15_g1 * 1.0 ) );
			o.Metallic = _Metallic;
			float temp_output_2_0 = _Smoothness;
			o.Smoothness = temp_output_2_0;
			o.Occlusion = specularIntensity15_g1;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18935
536;73;2067;851;1845.139;387.756;1.509515;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-65.78446,131.794;Inherit;False;Property;_Metallic;Metallic;3;0;Create;True;0;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
...
WireConnection;0;5;35;17
ASEEND*/
//CHKSM=C362C539706DE19CD991FD5EFE92755C24EFA67A